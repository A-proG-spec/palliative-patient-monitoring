 ...
 */
export const USE_MOCK =  (import.meta.env.VITE_USE_MOCK ?? 'false').toLowerCase() === 'true';export const API_URL = import.meta.env.VITE_API_URL || 'http://localhost:5000/api/v1';
